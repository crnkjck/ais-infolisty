...
download_data("sk");
download_data("en");
process_data("sk","regular","template_url_sk.csv");
process_data("en","regular","template_url_en.csv");
process_data("sk","statnice","template_url_sk.csv");
process_data("en","statnice","template_url_en.csv");
create_links("sk");
create_links("en");
